---
name: ykbb
description: City of Yellowknife Building By-law No. 5058 (2022) reference with the full 39-page by-law PDF bundled — the enforceable municipal building law inside City of Yellowknife, NWT. Use for any Yellowknife permit question: applicant / RDP / inspector responsibilities, permits, occupancy certificates, inspections, orders (stop-work, unsafe, do-not-occupy), offences and penalties, local construction deltas over the NBC (pinned-to-bedrock foundations, Schedule B piers, sprinklers and MFD ≥3 units per NFPA 13, hydrants, Yellowknife energy overlay per §64 + Schedules C & D, retaining walls per Schedule E), or citations like "§29", "§64", "Schedule B". By-law adopts NBC 2020 and NECB 2020 in entirety (§4–5) and prevails where it exceeds the NBC (§15 paramountcy). Applies inside City of Yellowknife only. Surfaces authoritative section with PDF page; recommends City Building Services Division confirmation. For NBC/NECB technical questions, route to canbc or canec skills.
---
